...
var Validator = function() {
    ...
    if (_.isArray(obj[property])) {
      if (obj[property].length === 0) {
        ...
        obj[property].forEach(function(item, i) {
          validateScalar(obj[property], [i, property].concat(path).reverse(), property+"["+i+"]");
        });
      }
    } else {
  ...
  validateMapProperty = function(obj, path, property, base) {
    if (!_.isDefined(obj[property]) || _.isNull(obj[property])) {
      return;
